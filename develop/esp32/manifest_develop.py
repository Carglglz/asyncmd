...
module("aiomqtt_sensor_bme280_service.py", base_path="example-aioservices/mqtt")
module("filehandler.py", base_path="tools/logging_handlers")
module("ursyslogger.py", base_path="tools/logging")
module("rsysloghandler.py", base_path="tools/logging_handlers")
